...
A pact is the agreement between you and your agent. It captures the agent's intent, the execution plan, the policy boundaries you enforce, and when the authority expires. When you approve a pact, Cobo Agentic Wallet creates a scoped delegation with enforced policies — the agent can operate, but only within the boundaries you defined.
...
1. Agent proposes a pact
   ...
   └── Specifies: spending limits, allowed contracts, duration
