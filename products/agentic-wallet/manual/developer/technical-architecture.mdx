...
| `AgentWalletToolkit` | 6 agent runtime tools (list_wallets, get_balance, transfer_tokens, list_transactions, get_audit_logs, create_delegation) wrapped for LLM consumption |
