...
Most developers should ignore the advanced integration modes at first. Start in standard Agent Mode: your runtime integrates with CAW, and Cobo provides the owner-facing pairing, policy, and approval surfaces.
