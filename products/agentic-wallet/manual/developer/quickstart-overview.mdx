...
- the wallet owner pairs once in the Human App
...
Use this if your runtime is Node.js or TypeScript-first, or you plan to integrate with Vercel AI SDK, Mastra, or TypeScript LangChain/OpenAI stacks.
