...
Ask your user to generate a pairing code from the Human App. See [Guide your users](/developer/quickstart/guide-users) for instructions to share with them. Then provision your agent:
