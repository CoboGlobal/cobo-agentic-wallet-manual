...
Run the interactive onboarding wizard. You will need an invitation code — [apply for early access](https://agenticwallet.cobo.com/agentic-wallet/waitlist/apply) to get one.
