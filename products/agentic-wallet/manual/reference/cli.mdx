...
and whether ownership pairing has been completed (wallet_paired boolean).
...
List pacts accessible to the authenticated principal. Filter by
--status (e.g. active, pending_approval, completed). Results are paginated.
