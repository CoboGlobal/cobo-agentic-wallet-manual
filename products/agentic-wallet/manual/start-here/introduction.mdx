...
<AccordionGroup>
  ...
  <Accordion title="How do I stop everything immediately?">
    You can use the Cobo Agentic Wallet app to freeze a wallet. There is no delay — it takes effect the moment you confirm. For details, see [Pause or revoke agent access](/products/agentic-wallet/manual/owners/freeze).
  </Accordion>
</AccordionGroup>
