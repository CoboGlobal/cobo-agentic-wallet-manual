...
<img src="/products/agentic-wallet/manual/images/approve-transaction.png" className="screenshot_modal" alt="Approval Details screen showing a pending transfer with Reject and Approve options" />
