...
- **Pending approval** — the operation is allowed in principle but exceeds a threshold that requires the owner to sign off first. See [Set Policies](/products/agentic-wallet/manual/guides/set-policies) for how to configure approval thresholds.
