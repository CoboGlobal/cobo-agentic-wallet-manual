...
A **human** becomes a principal by authenticating via the Human App. An **agent** becomes a principal by calling the API to register itself. Both receive a principal ID and interact via that ID.
