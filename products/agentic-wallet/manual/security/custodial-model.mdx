...
<Info>
If you are using an MPC wallet, your security model is different — key shares are distributed between you, your agent, and Cobo so no single party can act unilaterally. See [MPC Model](/products/agentic-wallet/manual/security/mpc-key-shares).
</Info>
...
<Info>
For details on how transaction policies and spend limits are enforced on custodial wallet operations, see [Policy Engine](/products/agentic-wallet/manual/security/policy-engine) and [Spend Limits](/products/agentic-wallet/manual/security/spend-limits).
</Info>
