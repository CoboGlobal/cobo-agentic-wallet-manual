...
`AgentWalletToolkit` provides 7 canonical tool definitions that framework-specific integrations (LangChain, OpenAI, Agno, CrewAI, MCP) consume and adapt to their runtimes.
...
Returns 7 `ToolDefinition` objects:
